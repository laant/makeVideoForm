...
7. **빌린 것 / 바꾼 것** 구분 표: 레퍼런스에서 가져온 구조·장치 vs 내 주제에 맞춰 새로 쓴 부분

**금지**: 레퍼런스·`brief`·제공 자료에 없는 성과(조회수·수익·전후 수치), 개인 경험("제가 써 보니…"), 후기·인용을 지어내지 않는다.
필요하면 "자료에 없음"으로 표시하고 사용자에게 받는다.
